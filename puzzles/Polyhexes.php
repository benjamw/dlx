...
abstract class Polyhexes
{
	 ...
	 *       symmetry -> how many rotations before coming back to self (6, 3, 2, or 1)
	 *       points -> points array
	 *     )
	 *
	 * @var array
	 ...
	 * @return void
	 */
	public function place(array $pieces) {
		if (1 !== func_num_args( )) {
	 ...
	 * @return array
	 */
	public static function layoutToArray(string $string) {
		$layout = [];
...
// TODO: check and see if a for loop is faster for this particular rotation
	 ...
	 * @return void
	 */
	public static function printPiece(array $piece) {
